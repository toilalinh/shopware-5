...
{block name="frontend_index_checkout_actions_cart"}
    <div id="miniBasket" class="basketBox">
        <span class="counter"><span id="countValue">{$sBasketQuantity}</span></span>
        <img src="{link file='frontend/_public/src/img/basket.png'}" id="minibasketIcon" alt="Basket">
    </div>
    <div id="basketFlyout" class="basketFlyout corners" style="display: none;">
    </div>
{/block}
