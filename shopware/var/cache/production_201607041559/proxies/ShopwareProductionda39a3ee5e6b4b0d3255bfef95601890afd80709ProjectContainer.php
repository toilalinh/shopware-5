...
class ShopwareProductionda39a3ee5e6b4b0d3255bfef95601890afd80709ProjectContainer extends Shopware\Components\DependencyInjection\Container
{
    ...
    {
        return $this->services['cache'] = $this->get('cache_factory')->factory('auto', array('automatic_serialization' => true, 'automatic_cleaning_factor' => 0, 'lifetime' => 3600, 'cache_id_prefix' => 'd1362fa43d831e19bd8fb14083a40925'), array('hashed_directory_perm' => 511, 'cache_file_perm' => 438, 'hashed_directory_level' => 3, 'cache_dir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/general', 'file_name_prefix' => 'shopware'));
    }
    ...
    {
        return $this->services['db'] = \Shopware\Components\DependencyInjection\Bridge\Db::createEnlightDbAdapter($this->get('dbal_connection'), array('username' => 'root', 'password' => 'root', 'dbname' => 'shopware5.2', 'host' => 'localhost', 'charset' => 'utf8', 'adapter' => 'pdo_mysql', 'port' => '3306'));
    }
    ...
    {
        return $this->services['dbal_connection'] = \Shopware\Components\DependencyInjection\Bridge\Db::createDbalConnection(array('username' => 'root', 'password' => 'root', 'dbname' => 'shopware5.2', 'host' => 'localhost', 'charset' => 'utf8', 'adapter' => 'pdo_mysql', 'port' => '3306'), $this->get('modelconfig'), $this->get('model_event_manager'), $this->get('db_connection'));
    }
    ...
    {
        return $this->services['hooks'] = new \Enlight_Hook_HookManager($this->get('events'), $this->get('loader'), array('proxyDir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/proxies', 'proxyNamespace' => 'Shopware_Proxies'));
    }
    ...
    {
        return $this->services['modelannotations'] = $this->get('model_annotations_factory')->factory($this->get('modelconfig'), '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Models');
    }
    protected function getModelconfigService()
    {
        return $this->services['modelconfig'] = new \Shopware\Components\Model\Configuration(array('autoGenerateProxyClasses' => false, 'attributeDir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/doctrine/attributes', 'proxyDir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/doctrine/proxies', 'proxyNamespace' => 'Shopware\\Proxies', 'cacheProvider' => 'auto', 'cacheNamespace' => NULL), $this->get('cache'), new \Shopware\Components\Model\ProxyAwareRepositoryFactory($this->get('hooks')));
    }
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/log/core_production.log', 14);
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/log/plugin_production.log', 14);
        $a->pushProcessor($this->get('monolog.processor.uid'));
    ...
    {
        return $this->services['plugins'] = $this->get('plugins_factory')->factory($this, $this->get('loader'), $this->get('events'), $this->get('application'), array('Default' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Default/', 'Local' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Local/', 'Community' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Community/'));
    }
    ...
    {
        return $this->services['shopware.openssl_verificator'] = new \Shopware\Components\OpenSSLVerifier('/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Components/HttpClient/public.key');
    }
    ...
    {
        return $this->services['shopware.snippet_database_handler'] = new \Shopware\Components\Snippet\DatabaseHandler($this->get('models'), $this->get('db'), '/Users/Shared/development/projects_git/webshop/shopware-5/shopware');
    }
    protected function getShopware_SnippetQueryHandlerService()
    {
        return $this->services['shopware.snippet_query_handler'] = new \Shopware\Components\Snippet\QueryHandler('/Users/Shared/development/projects_git/webshop/shopware-5/shopware/snippets/');
    }
    ...
    {
        return $this->services['shopware_account.constraint.current_password_validator'] = new \Shopware\Bundle\AccountBundle\Constraint\CurrentPasswordValidator($this->get('session'), $this->get('snippets'), $this->get('passwordencoder'));
    }
    ...
    {
        return $this->services['shopware_attribute.repository_registry'] = new \Shopware\Bundle\AttributeBundle\Repository\Registry(array(0 => $this->get('shopware_attribute.media_repository'), 1 => $this->get('shopware_attribute.blog_repository'), 2 => $this->get('shopware_attribute.product_repository'), 3 => $this->get('shopware_attribute.category_repository'), 4 => $this->get('shopware_attribute.property_option_repository'), 5 => $this->get('shopware_attribute.customer_repository'), 6 => $this->get('shopware_attribute.premium_repository'), 7 => $this->get('shopware_attribute.shop_repository')), $this->get('models'));
    }
    ...
    {
        return $this->services['shopware_plugininstaller.legacy_plugin_installer'] = new \Shopware\Bundle\PluginInstallerBundle\Service\LegacyPluginInstaller($this->get('models'), $this->get('plugins'), array('Default' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Default/', 'Local' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Local/', 'Community' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Community/'));
    }
    protected function getShopwarePlugininstaller_PluginDownloadServiceService()
    {
        return $this->services['shopware_plugininstaller.plugin_download_service'] = new \Shopware\Bundle\PluginInstallerBundle\Service\DownloadService('/Users/Shared/development/projects_git/webshop/shopware-5/shopware', array('Default' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Default/', 'Local' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Local/', 'Community' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Community/'), $this->get('shopware_plugininstaller.store_client'), $this->get('dbal_connection'));
    }
    protected function getShopwarePlugininstaller_PluginInstallerService()
    {
        return $this->services['shopware_plugininstaller.plugin_installer'] = new \Shopware\Bundle\PluginInstallerBundle\Service\PluginInstaller($this->get('models'), $this->get('shopware.snippet_database_handler'), $this->get('shopware.plugin_requirement_validator'));
    }
    ...
    {
        return $this->services['shopware_plugininstaller.store_client'] = new \Shopware\Bundle\PluginInstallerBundle\StoreClient($this->get('http_client'), 'https://api.shopware.com', $this->get('shopware_plugininstaller.plugin_installer_struct_hydrator'), $this->get('shopware.openssl_verificator'));
    }
    ...
    {
        return $this->services['shopware_searchdbal.dbal_query_builder_factory'] = new \Shopware\Bundle\SearchBundleDBAL\QueryBuilderFactory($this->get('dbal_connection'), $this->get('events'), array(0 => $this->get('shopware_searchdbal.vote_average_condition_handler_dbal'), 1 => $this->get('shopware_searchdbal.is_available_condition_handler_dbal'), 2 => $this->get('shopware_searchdbal.closeout_condition_handler_dbal'), 3 => $this->get('shopware_searchdbal.has_pseudo_price_condition_handler_dbal'), 4 => $this->get('shopware_searchdbal.is_new_condition_handler_dbal'), 5 => $this->get('shopware_searchdbal.release_date_condition_handler'), 6 => $this->get('shopware_searchdbal.create_date_condition_handler'), 7 => $this->get('shopware_searchdbal.search_condition_handler_dbal'), 8 => $this->get('shopware_searchdbal.category_condition_handler_dbal'), 9 => $this->get('shopware_searchdbal.ordernumber_condition_handler_dbal'), 10 => $this->get('shopware_searchdbal.product_attribute_condition_handler_dbal'), 11 => $this->get('shopware_searchdbal.customer_group_condition_handler_dbal'), 12 => $this->get('shopware_searchdbal.immediate_delivery_condition_handler_dbal'), 13 => $this->get('shopware_searchdbal.manufacturer_condition_handler_dbal'), 14 => $this->get('shopware_searchdbal.property_condition_handler_dbal'), 15 => $this->get('shopware_searchdbal.shipping_free_condition_handler_dbal'), 16 => $this->get('shopware_searchdbal.sales_condition_handler_dbal'), 17 => $this->get('shopware_searchdbal.price_condition_handler_dbal'), 18 => $this->get('shopware_searchdbal.similar_products_handler_dbal')), array(0 => $this->get('shopware_searchdbal.product_name_sorting_handler_dbal'), 1 => $this->get('shopware_searchdbal.popularity_sorting_handler_dbal'), 2 => $this->get('shopware_searchdbal.shopware_searchdbal.product_attribute_sorting_handler_dbal'), 3 => $this->get('shopware_searchdbal.release_date_sorting_handler_dbal'), 4 => $this->get('shopware_searchdbal.price_sorting_handler_sorting_handler_dbal'), 5 => $this->get('shopware_searchdbal.search_ranking_sorting_handler_dbal')));
    }
    ...
    {
        return $this->services['theme_compiler'] = new \Shopware\Components\Theme\Compiler('/Users/Shared/development/projects_git/webshop/shopware-5/shopware', $this->get('oyejorge_compiler'), $this->get('theme_path_resolver'), $this->get('theme_inheritance'), $this->get('theme_service'), $this->get('js_compressor'), $this->get('events'), $this->get('theme_timestamp_persistor'));
    }
    ...
    {
        return $this->services['theme_path_resolver'] = new \Shopware\Components\Theme\PathResolver('/Users/Shared/development/projects_git/webshop/shopware-5/shopware', array('Default' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Default/', 'Local' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Local/', 'Community' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Community/'), $this->get('template'));
    }
    ...
    {
        return $this->services['thumbnail_manager'] = new \Shopware\Components\Thumbnail\Manager($this->get('thumbnail_generator_basic'), '/Users/Shared/development/projects_git/webshop/shopware-5/shopware', $this->get('events'), $this->get('shopware_media.media_service'));
    }
    ...
    protected function getModelEventManagerService()
    {
        ...
        $instance->addEventSubscriber(new \Shopware\Bundle\ESIndexingBundle\Subscriber\ORMBacklogSubscriber($this));
        return $instance;
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware',
            'kernel.environment' => 'production',
            'kernel.debug' => false,
            'kernel.name' => 'Shopware',
            'kernel.cache_dir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559',
            'kernel.logs_dir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/log',
            ...
            'shopware.cdn' => array(
                ...
                'adapters' => array(
                    'local' => array(
                        ...
                        'path' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware',
                    ),
                    'ftp' => array(
                        'type' => 'ftp',
                        'mediaUrl' => '',
            ...
            'shopware.cdn.adapters.local.path' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware',
            ...
            'shopware.db.dbname' => 'shopware5.2',
            ...
            'shopware.plugin_directories' => array(
                'Default' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Default/',
                'Local' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Local/',
                'Community' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Community/',
            ),
            'shopware.plugin_directories.default' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Default/',
            'shopware.plugin_directories.local' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Local/',
            'shopware.plugin_directories.community' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/engine/Shopware/Plugins/Community/',
            'shopware.template' => array(
                ...
                'charset' => 'utf-8',
                'forceCache' => false,
                'cacheDir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/templates',
                'compileDir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/templates',
            ),
            ...
            'shopware.template.cachedir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/templates',
            'shopware.template.compiledir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/templates',
            'shopware.mail' => array(
                'charset' => 'utf-8',
            ),
            ...
            'shopware.httpcache' => array(
                ...
                'cache_dir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/html',
                'cache_cookies' => array(
                    0 => 'shop',
                    1 => 'currency',
            ...
            'shopware.httpcache.cache_dir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/html',
            ...
            'shopware.cache' => array(
                'frontendOptions' => array(
                    ...
                    'lifetime' => 3600,
                    'cache_id_prefix' => 'd1362fa43d831e19bd8fb14083a40925',
                ),
                'backend' => 'auto',
                'backendOptions' => array(
                    ...
                    'cache_dir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/general',
            ...
            'shopware.cache.frontendoptions.cache_id_prefix' => 'd1362fa43d831e19bd8fb14083a40925',
            ...
            'shopware.cache.backendoptions.cache_dir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/general',
            'shopware.cache.backendoptions.file_name_prefix' => 'shopware',
            'shopware.hook' => array(
                'proxyDir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/proxies',
                'proxyNamespace' => 'Shopware_Proxies',
            ),
            'shopware.hook.proxydir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/proxies',
            'shopware.hook.proxynamespace' => 'Shopware_Proxies',
            'shopware.model' => array(
                'autoGenerateProxyClasses' => false,
                'attributeDir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/doctrine/attributes',
                'proxyDir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/doctrine/proxies',
                'proxyNamespace' => 'Shopware\\Proxies',
                'cacheProvider' => 'auto',
                'cacheNamespace' => NULL,
            ),
            'shopware.model.autogenerateproxyclasses' => false,
            'shopware.model.attributedir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/doctrine/attributes',
            'shopware.model.proxydir' => '/Users/Shared/development/projects_git/webshop/shopware-5/shopware/var/cache/production_201607041559/doctrine/proxies',
