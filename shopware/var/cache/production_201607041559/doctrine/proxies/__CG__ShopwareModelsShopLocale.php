...
class Locale extends \Shopware\Models\Shop\Locale implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Shopware\\Models\\Shop\\Locale' . "\0" . 'id', '' . "\0" . 'Shopware\\Models\\Shop\\Locale' . "\0" . 'locale', '' . "\0" . 'Shopware\\Models\\Shop\\Locale' . "\0" . 'language', '' . "\0" . 'Shopware\\Models\\Shop\\Locale' . "\0" . 'territory'];
        }
    ...
    public function setTerritory($territory)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTerritory', [$territory]);
    ...
    public function getTerritory()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTerritory', []);
